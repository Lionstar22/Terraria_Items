...
public class TimLeggings extends Armor {
    ...
    public TimLeggings(Plugin plugin){
        super(plugin,"Tim Leggings","#FFFFFF", Material.LEATHER_LEGGINGS,"cactus_leggings","tim_armor", EquipmentSlot.LEGS,"TimLeggings",new ArrayList<>(List.of(ChatColor.GRAY+"How did you get this?")));
    }
