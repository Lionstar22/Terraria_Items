...
public class IceGolemLeggings extends Armor {
    ...
    public IceGolemLeggings(Plugin plugin){
        super(plugin,"unobtainable.name","#FFFFFF", Material.LEATHER_LEGGINGS,"cactus_chestplate","ice_golem_armor", EquipmentSlot.LEGS,"IceGolemLeggings","unobtainable.lore");
    }
