package me.carson.terrariaItems.armorFolder.armors.frozenZombieArmor;
...
public class FrozenZombieChestplate extends Armor {
    ...
    public FrozenZombieChestplate(Plugin plugin){
        super(plugin,"unobtainable.name","#FFFFFF", Material.LEATHER_CHESTPLATE,"cactus_chestplate","frozen_zombie_armor", EquipmentSlot.CHEST,"FrozenZombieChestplate","unobtainable.lore");
    }
