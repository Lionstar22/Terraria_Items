...
public class HallowedHelmet extends Armor implements Listener {
    ...
    public HallowedHelmet(Plugin plugin){
        super(plugin,"hallowed_helmet.name","#FF96FF", Material.NETHERITE_HELMET,"hallowed_helmet","hallowed_armor", EquipmentSlot.HEAD,"HallowedHelmet","hallowed_helmet.lore");
    }
