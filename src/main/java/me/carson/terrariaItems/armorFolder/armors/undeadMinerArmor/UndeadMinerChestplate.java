package me.carson.terrariaItems.armorFolder.armors.undeadMinerArmor;
...
public class UndeadMinerChestplate extends Armor {
    ...
    public UndeadMinerChestplate(Plugin plugin){
        super(plugin,"unobtainable.name","#FFFFFF", Material.LEATHER_CHESTPLATE,"cactus_chestplate","undead_miner_armor", EquipmentSlot.CHEST,"UndeadMinerChestplate","unobtainable.lore");
    }
