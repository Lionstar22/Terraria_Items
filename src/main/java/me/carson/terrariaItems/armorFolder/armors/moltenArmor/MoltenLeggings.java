...
public class MoltenLeggings extends Armor {
    ...
    public MoltenLeggings(Plugin plugin){
        super(plugin,"molten_leggings.name","#FFC896", Material.NETHERITE_LEGGINGS,"molten_leggings","molten_armor", EquipmentSlot.LEGS,"MoltenLeggings","molten_leggings.lore");
    }
