...
public class MoltenChestplate extends Armor {
    ...
    public MoltenChestplate(Plugin plugin){
        super(plugin,"molten_chestplate.name","#FFC896", Material.NETHERITE_CHESTPLATE,"molten_chestplate","molten_armor", EquipmentSlot.CHEST,"MoltenChestplate","molten_chestplate.lore");
    }
