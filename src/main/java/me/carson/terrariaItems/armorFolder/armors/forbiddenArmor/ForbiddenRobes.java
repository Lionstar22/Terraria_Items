...
public class ForbiddenRobes extends Armor {
    ...
    public ForbiddenRobes(Plugin plugin){
        super(plugin,"forbidden_robes.name","#FF96FF", Material.NETHERITE_CHESTPLATE,"forbidden_robes","forbidden_armor",EquipmentSlot.CHEST,"ForbiddenRobes","forbidden_robes.lore");
    }
