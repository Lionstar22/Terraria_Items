package me.carson.terrariaItems.armorFolder.armors.raincoatZombieArmor;
...
public class RaincoatZombieChestplate extends Armor {
    ...
    public RaincoatZombieChestplate(Plugin plugin){
        super(plugin,"unobtainable.name","#FFFFFF", Material.LEATHER_CHESTPLATE,"cactus_chestplate","raincoat_zombie_armor", EquipmentSlot.CHEST,"RaincoatZombieChestplate","unobtainable.lore");
    }
