...
public class FrostHelmet extends Armor {
    ...
    public FrostHelmet(Plugin plugin){
        super(plugin,"frost_helmet.name","#FF96FF", Material.NETHERITE_HELMET,"frost_helmet","frost_armor", EquipmentSlot.HEAD,"FrostHelmet","frost_helmet.lore");
    }

    public static ItemStack getItem(Plugin plugin) {
        ItemStack item= new FrostHelmet(plugin).createItem();
        ItemMeta meta=item.getItemMeta();
        meta.addAttributeModifier(Attribute.ARMOR,new AttributeModifier(new NamespacedKey(plugin,"frost_helmet_armor"),5.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.HEAD));
