...
public class RuneWizardChestplate extends Armor {
    ...
    public RuneWizardChestplate(Plugin plugin){
        super(plugin,"unobtainable.name","#FFFFFF", Material.LEATHER_CHESTPLATE,"cactus_chestplate","rune_wizard_armor", EquipmentSlot.CHEST,"RuneWizardChestplate","unobtainable.lore");
    }
