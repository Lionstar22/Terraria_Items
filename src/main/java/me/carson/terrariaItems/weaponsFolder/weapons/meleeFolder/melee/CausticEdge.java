...
public class CausticEdge extends Sword {
    ...
    public static ItemStack getItem(Plugin plugin) {
        ItemStack item=new CausticEdge(plugin).createItem();
        ...
        meta.addAttributeModifier(Attribute.ATTACK_DAMAGE,new AttributeModifier(new NamespacedKey(plugin,"attack"),17, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND));
    ...
    public void leftActivate(Player player) {
        ...
        new CausticBeam(plugin).createProjectile(player,speed,damage,spread,duration);
    }
