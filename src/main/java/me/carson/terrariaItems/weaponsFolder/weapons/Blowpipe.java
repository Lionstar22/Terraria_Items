...
public class Blowpipe extends Weapon {
    ...
    public Blowpipe(Plugin plugin) {
        super(plugin,"Blowpipe","#FFFFFF",0,0, Material.STICK,"blowpipe","Blowpipe",20, new ArrayList<>(List.of(ChatColor.GRAY+"Uses seeds for Ammo")));
    }
    ...
    public void rightActivate(Player player) {
        if (player.getInventory().contains(Material.WHEAT_SEEDS)) {
            ...
            new Seed(plugin).createProjectile(player,super.damage,super.spread);
