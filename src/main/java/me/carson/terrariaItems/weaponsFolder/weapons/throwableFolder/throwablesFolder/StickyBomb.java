...
import me.carson.terrariaItems.throwablesFolder.throwables.StickyBombObj;
...
public class StickyBomb extends ThrowableWeapon {
    ...
    public void rightActivate(Player player) {
        ...
        new StickyBombObj(plugin).createThrowableObj(player,speed,damage,spread,duration,0,0.05f);
    }
