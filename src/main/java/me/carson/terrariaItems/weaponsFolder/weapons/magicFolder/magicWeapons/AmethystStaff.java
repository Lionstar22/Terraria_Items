...
public class AmethystStaff extends Magic {
    ...
    public AmethystStaff(Plugin plugin) {
        super(plugin,"Amethyst Staff","#FFFFFF", Material.RAW_COPPER,"amethyst_staff","AmethystStaff",15,1,4,0,50,5, new ArrayList<>(List.of(ChatColor.GRAY+"Fires a amethyst bolt",ChatColor.GRAY+"Costs 5 Mana")));
    }
