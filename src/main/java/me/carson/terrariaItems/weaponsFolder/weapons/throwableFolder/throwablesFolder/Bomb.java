...
public class Bomb extends ThrowableWeapon {
    ...
    public Bomb(Plugin plugin) {
        super(plugin,"bomb.name","#FFFFFF", Material.GUNPOWDER,"bomb","Bomb",15,0.75f,0,0,60,"bomb.lore");
    }
    ...
    public void rightActivate(Player player) {
        ...
        new BombProjectile(plugin).createThrowableObj(player,speed,damage,spread,duration,0,0.05f);
    }

    public static ItemStack getItem(Plugin plugin) {
        ItemStack item =new Bomb(plugin).createItem();
