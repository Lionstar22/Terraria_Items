...
public class BouncyDynamiteProjectile extends Throwable {

    public BouncyDynamiteProjectile(Plugin plugin) {
        super(plugin, 0,  "bouncy_dynamite", "BouncyDynamiteProjectile",99,0,1f,1f, DamageType.ARROW);
    }
