...
public class StickyBombProjectile extends Throwable {

    public StickyBombProjectile(Plugin plugin) {
        super(plugin, 0,  "sticky_bomb", "StickyBombProjectile",99,0,0f,0.95f, DamageType.ARROW);
    }
