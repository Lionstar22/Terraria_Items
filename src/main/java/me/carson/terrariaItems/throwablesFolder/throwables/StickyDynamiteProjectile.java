...
public class StickyDynamiteProjectile extends Throwable {

    public StickyDynamiteProjectile(Plugin plugin) {
        super(plugin, 0,  "sticky_dynamite", "StickyDynamiteProjectile",99,0,0f,0.98f, DamageType.ARROW);
    }
