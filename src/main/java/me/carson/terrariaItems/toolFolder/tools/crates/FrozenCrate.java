...
public class FrozenCrate extends Tool {
    ...
    public void rightActivate(Player player) {
        ...
        switch (treasure){
            case 1 ->  player.getWorld().dropItemNaturally(player.getLocation(),IceBlade.getItem(plugin));
            case 2 ->  player.getWorld().dropItemNaturally(player.getLocation(),SnowballCannon.getItem(plugin));
            case 3 ->  player.getWorld().dropItemNaturally(player.getLocation(), BlizzardInABottle.getItem(plugin));
            default -> {
                return;
            }
        }
        ...
        if(chance<0.05){//Misc Loot table
    ...
    public static ItemStack getItem(Plugin plugin) {
        ItemStack item=new FrozenCrate(plugin).createItem();
