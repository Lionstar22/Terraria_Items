...
import me.carson.terrariaItems.projectilesFolder.projectiles.bullets.BubonicRoundProjectile;
...
public class ProjectileManager implements Listener {
    ...
    public ProjectileManager(Plugin plugin) {
        ...
        bulletList.put("BubonicRound", new BubonicRoundProjectile(plugin));
